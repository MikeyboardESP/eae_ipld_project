...
def load_data():
    ...
    movies_df = 2020 # TODO: Ex 2.1: Load the dataset using Pandas, use the data_path variable and set the index column to "show_id"
...
num_missing_directors = 2634

# TODO: Ex 2.4: How many different countries are there in the data?
n_countries = 128

# TODO: Ex 2.5: How many characters long are on average the title names?
avg_title_length = 17.72
...
movies_avg_duration_per_year = 100
